...
#define SIGMA8 (0.83) // rms mass fluctuation on 8/hlittle Mpc scales at z=0
//#define hlittle (0.67) // little hubble h
#define OMm  (Omega_m) // at z=0
#define OMl  (Omega_l) // at z=0
#define OMb  (Omega_b) // at z=0
#define OMn  (Omega_n)
#define OMk  (Omega_k)
#define OMr  (Omega_r)
#define OMtot (Omega_tot)
//#define Y_He (0.24)
#define POWER_INDEX (0.96) /* power law index for the power spectrum */
